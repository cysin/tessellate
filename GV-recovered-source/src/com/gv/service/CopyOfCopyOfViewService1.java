...
public class CopyOfCopyOfViewService1 {
    public List<Material> createView(List<Product> m_products, List<Material> m_materials, double saw_bite) {
        ...
        while (it.hasNext()) {
                                    ...
                                    if (p_count == 0) {
                                        ...
                                        if (p_count == 0) {
                                                            ...
                                                            if (t_m.getR_width() >= t_p.getP_width() + saw_bite && t_m.getR_height() == t_p.getP_height()) {
                                                                ...
                                                                if (1 == pp_count) {
                                                                    ...
                                                                    while (pi < e_products.size()) {
                                                                        pj = e_products.size() - 1;
                                                                        while (pj > pi) {
                                                                            mod = t_m.getR_height() - ((Product)e_products.get(pi)).getP_width() - ((Product)e_products.get(pj)).getP_width() - saw_bite;
                                                                            if (mod >= 0.0 && mod < m_mod) {
                                                                                b_product1 = (Product)e_products.get(pi);
                                                                                b_product2 = (Product)e_products.get(pj);
                                                                                m_mod = mod;
                                            ...
                                            while (i_i < index) {
                                                ...
                                                Iterator<Object> iterator = vt_t.iterator();
            ...
            block34: for (Product m_product : m_products) {
                if (m_product.getP_is_copy() != 0) continue;
                int p_t_count = 0;
                int m_i = 0;
                while (m_i < b_materials.size()) {
                    if (((Material)b_materials.get(m_i)).getM_is_show() == 0) {
                        for (Product pp_product : ((Material)b_materials.get(m_i)).getM_products()) {
                            if ((!m_product.getP_name().equals(pp_product.getP_name()) || m_product.getP_width() != pp_product.getP_width() || m_product.getP_height() != pp_product.getP_height() || pp_product.getP_is_copy() != 0) && (!m_product.getP_name().equals(pp_product.getP_name()) || m_product.getP_height() != pp_product.getP_width() || m_product.getP_width() != pp_product.getP_height() || 1 != pp_product.getP_is_copy())) continue;
                            p_t_count += ((Material)b_materials.get(m_i)).getM_u_count();
                        }
                        if ((double)p_t_count > m_product.getP_count()) {
                            double cha = (double)p_t_count - m_product.getP_count();
                            System.out.println(String.valueOf(m_product.getP_name()) + m_product.getP_width() + m_product.getP_height() + "\u591a\u5f00\u4e86" + cha);
                            if (1 < ((Material)b_materials.get(m_i)).getM_u_count()) {
                                Material mmm2 = CommonTools.cloneScheme((Material)b_materials.get(m_i));
                                mmm2.setM_u_count(1);
                                ((Material)b_materials.get(m_i)).setM_u_count(((Material)b_materials.get(m_i)).getM_u_count() - 1);
                                int p_i = mmm2.getM_products().size() - 1;
                                while (p_i >= 0) {
                                    if ((m_product.getP_name().equals(mmm2.getM_products().get(p_i).getP_name()) && m_product.getP_width() == mmm2.getM_products().get(p_i).getP_width() && m_product.getP_height() == mmm2.getM_products().get(p_i).getP_height() && mmm2.getM_products().get(p_i).getP_is_copy() == 0 || m_product.getP_name().equals(mmm2.getM_products().get(p_i).getP_name()) && m_product.getP_height() == mmm2.getM_products().get(p_i).getP_width() && m_product.getP_width() == mmm2.getM_products().get(p_i).getP_height() && 1 == mmm2.getM_products().get(p_i).getP_is_copy()) && 0.0 < cha) {
                                        mmm2.getM_products().remove(p_i);
                                        cha -= 1.0;
                                    }
                                    --p_i;
                                }
                                b_materials.add(mmm2);
                                continue block34;
                            }
                            int p_i = ((Material)b_materials.get(m_i)).getM_products().size() - 1;
                            while (p_i >= 0) {
                                if ((m_product.getP_name().equals(((Material)b_materials.get(m_i)).getM_products().get(p_i).getP_name()) && m_product.getP_width() == ((Material)b_materials.get(m_i)).getM_products().get(p_i).getP_width() && m_product.getP_height() == ((Material)b_materials.get(m_i)).getM_products().get(p_i).getP_height() && ((Material)b_materials.get(m_i)).getM_products().get(p_i).getP_is_copy() == 0 || m_product.getP_name().equals(((Material)b_materials.get(m_i)).getM_products().get(p_i).getP_name()) && m_product.getP_height() == ((Material)b_materials.get(m_i)).getM_products().get(p_i).getP_width() && m_product.getP_width() == ((Material)b_materials.get(m_i)).getM_products().get(p_i).getP_height() && 1 == ((Material)b_materials.get(m_i)).getM_products().get(p_i).getP_is_copy()) && 0.0 < cha) {
                                    ((Material)b_materials.get(m_i)).getM_products().remove(p_i);
                                    cha -= 1.0;
                                }
                                --p_i;
                            }
            ...
            for (Material mm : b_materials) {
                ...
                for (Material y_material : m_y_materials) {
                    if (y_material.getM_is_show() != 0) continue;
                    if (y_material.getM_m_left() + y_material.getR_width() + 12.0 == y_material.getM_width()) {
                        y_material.setR_width(y_material.getR_width() + 6.0);
                        if (y_material.getM_m_top() + y_material.getR_height() + 12.0 != y_material.getM_height()) continue;
                        y_material.setR_height(y_material.getR_height() + 6.0);
                        continue;
                    }
                    if (y_material.getM_m_top() + y_material.getR_height() + 12.0 != y_material.getM_height()) continue;
                    y_material.setR_height(y_material.getR_height() + 6.0);
