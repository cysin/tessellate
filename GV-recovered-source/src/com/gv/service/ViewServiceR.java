...
public class ViewServiceR {
    public List<Material> createView(List<Product> m_products, List<Material> m_materials, double saw_bite) {
        ...
        while (it.hasNext()) {
                    ...
                    if (mm_products.size() > 0) {
                        ...
                        if ((m_materials = this.scoreMaterial(m_materials)) == null) {
                            ...
                            while (i < m_materials.size()) {
                                Vector<Material> vc_f = new Vector<Material>();
                                int f_i = 0;
                                while (f_i < 10) {
                                    Iterator<Product> material = new Material();
                                    m_materials = CommonTools.cloneMatList(m_materials);
                                    Random rd = new Random();
                                    ArrayList f_materials = new ArrayList();
                                        ...
                                        if (!(m_material.getR_height() < p.getP_height()) && !(m_material.getR_width() < p.getP_width())) {
                                            ...
                                            if (p_count == 0) {
                                                ...
                                                if (p_count == 0) {
                                                    ...
                                                    ((Material)((Object)material)).setM_name(m_materials.get(m_m_no).getM_name());
                                                    ((Material)((Object)material)).setM_count(m_materials.get(m_m_no).getM_count());
                                                    ((Material)((Object)material)).setM_color(m_materials.get(m_m_no).getM_color());
                                                    ((Material)((Object)material)).setM_products(m_materials.get(m_m_no).getM_products());
                                                    ((Material)((Object)material)).setM_height(m_materials.get(m_m_no).getM_height());
                                                    ((Material)((Object)material)).setM_width(m_materials.get(m_m_no).getM_width());
                                                    ((Material)((Object)material)).setR_height(m_materials.get(m_m_no).getR_height());
                                                    ((Material)((Object)material)).setR_width(m_materials.get(m_m_no).getR_width());
                                                    ((Material)((Object)material)).setM_weight(m_materials.get(m_m_no).getM_weight());
                                                    if (1.0 == ((Material)((Object)material)).getM_count()) {
                                                        System.out.println("\u539f\u6599:" + ((Material)((Object)material)).getM_name() + "\u7528\u5b8c\u4e86\uff01");
                                                        m_materials.remove(m_m_no);
                                                    } else {
                                                        m_materials.get(m_m_no).setM_count(((Material)((Object)material)).getM_count() - 1.0);
                                                    }
                                                    p = new Product();
                                                    p.setM_left(0.0);
                                                    p.setM_top(0.0);
                                                    ...
                                                    m_ps.add(p);
                                                    p = null;
                                                    ((Material)((Object)material)).setM_products(m_ps);
                                                    f_materials.add(material);
                                                    int index = 1;
                                                    ...
                                                    if (rd.nextBoolean()) {
                                                        ...
                                                        t_material.setR_height(DecimalMath.mul(DecimalMath.mul(((Material)((Object)material)).getR_height(), product.getP_height()), saw_bite));
                                                        t_material.setR_width(((Material)((Object)material)).getR_width());
                                                        t_material.setM_width(((Material)((Object)material)).getM_width());
                                                        t_material.setM_height(((Material)((Object)material)).getM_height());
                                                        t_material.setM_f_id(((Material)((Object)material)).getM_node_id());
                                                        ...
                                                        f_materials.add(t_material);
                                                        t_material = new Material();
                                                        t_material.setR_height(product.getP_height());
                                                        t_material.setR_width(DecimalMath.mul(DecimalMath.mul(((Material)((Object)material)).getR_width(), product.getP_width()), saw_bite));
                                                        t_material.setM_width(((Material)((Object)material)).getM_width());
                                                        t_material.setM_height(((Material)((Object)material)).getM_height());
                                                        t_material.setM_f_id(((Material)((Object)material)).getM_node_id());
                                                        t_material.setM_node_id(node_id);
                                                        ...
                                                        f_materials.add(t_material);
                                                        t_material = new Material();
                                                        t_material.setR_height(((Material)((Object)material)).getR_height());
                                                        t_material.setR_width(DecimalMath.mul(DecimalMath.mul(((Material)((Object)material)).getR_width(), product.getP_width()), saw_bite));
                                                        t_material.setM_width(((Material)((Object)material)).getM_width());
                                                        t_material.setM_height(((Material)((Object)material)).getM_height());
                                                        t_material.setM_f_id(((Material)((Object)material)).getM_node_id());
                                                    ...
                                                    while (it_t.hasNext()) {
                                                        ...
                                                        for (List materials_index : vt) {
                                                            block8: for (Material t_m : materials_index) {
                                                                for (Product t_p : mm_products) {
                                                                    ...
                                                                    if (t_p.getP_r_count() <= 0 || (t_p = this.queryIsUsedProduct(f_materials, t_p)).getP_r_count() <= t_p.getP_p_count()) continue;
                                                                    ...
                                                                    if (t_m.getR_width() == t_p.getP_width() && t_m.getR_height() >= t_p.getP_height() + saw_bite) {
                                                                        ...
                                                                        if (1 == pp_count) {
                                                                            ...
                                                                            while (pi < e_products.size()) {
                                                                                ...
                                                                                while (pj >= pi) {
                                                                                    if ((pi != pj || 2 <= ((Product)e_products.get(pi)).getP_r_count()) && (mod = t_m.getR_height() - ((Product)e_products.get(pi)).getP_height() - ((Product)e_products.get(pj)).getP_height() - saw_bite) >= 0.0 && mod < m_mod) {
                                                                            ...
                                                                            while (pi < e_products.size()) {
                                                                                pj = e_products.size() - 1;
                                                                                while (pj >= pi) {
                                                                                    pm = e_products.size() - 1;
                                                                                    while (pm >= pi) {
                                                                                        if ((pi != pj && pi != pm && pm != pj || 2 <= ((Product)e_products.get(pi)).getP_r_count()) && (pi != pj || pi != pm || 3 <= ((Product)e_products.get(pi)).getP_r_count()) && (mod = t_m.getR_height() - ((Product)e_products.get(pi)).getP_height() - ((Product)e_products.get(pj)).getP_height() - ((Product)e_products.get(pm)).getP_height() - 2.0 * saw_bite) >= 0.0 && mod < m_mod) {
                                                                                            b_product1 = (Product)e_products.get(pi);
                                                                                            b_product2 = (Product)e_products.get(pj);
                                                                                            b_product3 = (Product)e_products.get(pm);
                                                                                            m_mod = mod;
                                                                                        }
                                                                                        --pm;
                                                                                    }
                                                                            ...
                                                                            if (b_product1 != null && b_product2 != null) {
                                                                                ...
                                                                                if (b_product3 != null) {
                                                                                    p = new Product();
                                                                                    p.setM_left(t_m.getM_m_left());
                                                                                    p.setM_top(DecimalMath.add(DecimalMath.add(DecimalMath.add(t_m.getM_m_top(), b_product1.getP_height()), 2.0 * saw_bite), ((Product)b_product2).getP_height()));
                                                                                    p.setP_no(b_product3.getP_no());
                                                                                    p.setP_name(b_product3.getP_name());
                                                                                    p.setP_height(b_product3.getP_height());
                                                                                    p.setP_width(b_product3.getP_width());
                                                                                    p.setP_is_copy(b_product3.getP_is_copy());
                                                                                    p.setP_is_dir(b_product3.getP_is_dir());
                                                                                    p.setP_is_show(t_m.getM_node_id());
                                                                                    m_ps.add(p);
                                                                                    p = null;
                                                                                }
                                                                                ...
                                                                                t_material = new Material();
                                                                                if (b_product3 != null) {
                                                                                    t_material.setR_height(DecimalMath.mul(DecimalMath.mul(DecimalMath.mul(t_m.getR_height(), ((Product)b_product2).getP_height()), DecimalMath.mul(b_product1.getP_height(), DecimalMath.sub(3.0, saw_bite))), b_product3.getP_height()));
                                                                                } else {
                                                                                ...
                                                                                if (b_product3 != null) {
                                                                                    t_material.setM_m_top(DecimalMath.add(DecimalMath.add(DecimalMath.add(t_m.getM_m_top(), ((Product)b_product2).getP_height()), DecimalMath.add(b_product1.getP_height(), DecimalMath.sub(3.0, saw_bite))), b_product3.getP_height()));
                                                                                } else {
                                                                    ...
                                                                    if (t_m.getR_width() >= t_p.getP_width() + saw_bite && t_m.getR_height() == t_p.getP_height()) {
                                                                        ...
                                                                        if (1 == pp_count) {
                                                                            ...
                                                                            while (pi < e_products.size()) {
                                                                                pj = e_products.size() - 1;
                                                                                while (pj >= pi) {
                                                                                    if ((pi != pj || 2 <= ((Product)e_products.get(pi)).getP_r_count()) && (mod = t_m.getR_width() - ((Product)e_products.get(pi)).getP_width() - ((Product)e_products.get(pj)).getP_width() - saw_bite) >= 0.0 && mod < m_mod) {
                                                                                        b_product1 = (Product)e_products.get(pi);
                                                                                        b_product2 = (Product)e_products.get(pj);
                                                                                        m_mod = mod;
                                                                                    }
                                                                            ...
                                                                            while (pi < e_products.size()) {
                                                                                ...
                                                                                while (pj >= pi) {
                                                                                    pm = e_products.size() - 1;
                                                                                    while (pm >= pi) {
                                                                                        if ((pi != pj && pi != pm && pm != pj || 2 <= ((Product)e_products.get(pi)).getP_r_count()) && (pi != pj || pi != pm || 3 <= ((Product)e_products.get(pi)).getP_r_count()) && (mod = t_m.getR_width() - ((Product)e_products.get(pi)).getP_width() - ((Product)e_products.get(pj)).getP_width() - ((Product)e_products.get(pm)).getP_width() - 2.0 * saw_bite) >= 0.0 && mod < m_mod) {
                                                                                            b_product1 = (Product)e_products.get(pi);
                                                                                            b_product2 = (Product)e_products.get(pj);
                                                                                            b_product3 = (Product)e_products.get(pm);
                                                                                            m_mod = mod;
                                                                            ...
                                                                            if (b_product1 != null && b_product2 != null) {
                                                                                ...
                                                                                if (b_product3 != null) {
                                                                                    p = new Product();
                                                                                    p.setM_left(DecimalMath.add(DecimalMath.add(DecimalMath.add(t_m.getM_m_left(), b_product1.getP_width()), 2.0 * saw_bite), ((Product)b_product2).getP_width()));
                                                                                    p.setM_top(t_m.getM_m_top());
                                                                                    p.setP_no(b_product3.getP_no());
                                                                                    p.setP_name(b_product3.getP_name());
                                                                                    p.setP_height(b_product3.getP_height());
                                                                                ...
                                                                                if (b_product3 != null) {
                                                                                    t_material.setR_width(DecimalMath.mul(DecimalMath.mul(DecimalMath.mul(t_m.getR_width(), b_product1.getP_width()), DecimalMath.mul(((Product)b_product2).getP_width(), DecimalMath.sub(3.0, saw_bite))), b_product3.getP_width()));
                                                                                } else {
                                                                                ...
                                                                                t_material.setM_hs_type(1);
                                                                                if (b_product3 != null) {
                                                                                    t_material.setM_m_left(DecimalMath.add(DecimalMath.add(DecimalMath.add(t_m.getM_m_left(), b_product1.getP_width()), DecimalMath.add(((Product)b_product2).getP_width(), DecimalMath.sub(3.0, saw_bite))), b_product3.getP_width()));
                                                                                } else {
                                                    ...
                                                    ArrayList f_ps = new ArrayList();
                                                    Iterator<Object> iterator = f_materials.iterator();
                                                    while (iterator.hasNext()) {
                                                        Material f_m = (Material)iterator.next();
                                                        if (f_m.getM_products() == null) continue;
                                                        f_ps.addAll(CommonTools.cloneProList(f_m.getM_products()));
                                                    }
                                                    b_material = CommonTools.cloneScheme(material);
                                                    b_material.setM_products(f_ps);
                                                    b_material.setM_area_used(0.0);
                                                    for (Product b_p : b_material.getM_products()) {
                                                        b_material.setM_area_used(DecimalMath.add(b_material.getM_area_used(), DecimalMath.sub(b_p.getP_width(), b_p.getP_height())));
                                                    }
                                                    b_material.setM_area_used(b_material.getM_area_used() / DecimalMath.sub(b_material.getM_width(), b_material.getM_height()));
                                                    vc_f.add(b_material);
                                                    break;
                                                }
                                            }
                                ...
                                b_material = (Material)vc_f.get(0);
                                int b_i = 1;
                                while (b_i < vc_f.size()) {
                                    if (b_material.getM_area_used() < ((Material)vc_f.get(b_i)).getM_area_used()) {
                                        b_material = (Material)vc_f.get(b_i);
                                    }
                                    ++b_i;
                                }
            ...
            System.out.println("\u677f\u6750\u6570\u91cf:" + b_materials.size());
        ...
        Material i_material = new Material();
        i_material.setM_materials(i_materials);
        b_b_materials.add(i_material);
        Material t = (Material)b_b_materials.get(0);
        for (Product p : t.getM_products()) {
            System.out.println(String.valueOf(p.getM_left()) + ":" + p.getM_top());
        }
    ...
    public List<Product> queryUsedProducts(List<Material> f_materials) {
        ArrayList<Product> usedProducts = new ArrayList<Product>();
        for (Material f_m : f_materials) {
            if (f_m.getM_products() == null) continue;
            usedProducts.addAll(CommonTools.cloneProList(f_m.getM_products()));
        }
        int i = 0;
    ...
    public boolean checkIsProductd(List<Product> u_products, Product p_product) {
        boolean result = true;
    ...
    public Product queryIsUsedProduct(List<Material> f_materials, Product t_p) {
        ArrayList<Product> usedProducts = new ArrayList<Product>();
        for (Material f_m : f_materials) {
            if (f_m.getM_products() == null) continue;
            usedProducts.addAll(CommonTools.cloneProList(f_m.getM_products()));
        ...
        t_p.setP_p_count(0);
        if (t_p.getP_is_dir() == 0) {
            for (Product p_p : usedProducts) {
                if (p_p.getP_name().equals(t_p.getP_name()) && p_p.getP_height() == t_p.getP_height() && p_p.getP_width() == t_p.getP_width() && p_p.getP_is_copy() == t_p.getP_is_copy()) {
                    t_p.setP_p_count(t_p.getP_p_count() + 1);
                    continue;
                }
                if (!p_p.getP_name().equals(t_p.getP_name()) || p_p.getP_width() != t_p.getP_height() || p_p.getP_height() != t_p.getP_width() || 1 != p_p.getP_is_copy() + t_p.getP_is_copy()) continue;
                t_p.setP_p_count(t_p.getP_p_count() + 1);
            }
        } else {
            for (Product p_p : usedProducts) {
                if (!p_p.getP_name().equals(t_p.getP_name()) || p_p.getP_height() != t_p.getP_height() || p_p.getP_width() != t_p.getP_width() || p_p.getP_is_copy() != t_p.getP_is_copy()) continue;
                t_p.setP_p_count(t_p.getP_p_count() + 1);
            }
        }
        return t_p;
    ...
    public List<Product> scoreAreaProductUn(List<Product> products) {
        Product t_product = null;
        int i = 0;
        while (i < products.size()) {
            ...
            while (j < products.size()) {
                if (product.getP_height() * product.getP_width() < products.get(j).getP_height() * products.get(j).getP_width()) {
    ...
    public List<Product> scoreAreaProductBi(List<Product> products, int score) {
        List<Product> l_products = CommonTools.cloneProList(products);
        Product t_product = null;
        int i = 0;
        while (i < l_products.size()) {
            Product product = l_products.get(i);
            double y1 = product.getP_height() > product.getP_width() ? product.getP_height() : product.getP_width();
            double x1 = product.getP_height() > product.getP_width() ? product.getP_width() : product.getP_height();
            double c1 = DecimalMath.add(DecimalMath.sub(1.0, DecimalMath.sub(product.getP_height(), product.getP_width())), DecimalMath.sub(score, x1 / y1));
            int j = i + 1;
            while (j < l_products.size()) {
                double y2 = l_products.get(j).getP_height() > l_products.get(j).getP_width() ? l_products.get(j).getP_height() : l_products.get(j).getP_width();
                double x2 = l_products.get(j).getP_height() > l_products.get(j).getP_width() ? l_products.get(j).getP_width() : l_products.get(j).getP_height();
                double c2 = DecimalMath.add(DecimalMath.sub(1.0, DecimalMath.sub(l_products.get(j).getP_height(), l_products.get(j).getP_width())), DecimalMath.sub(score, x2 / y2));
                if (c1 < c2) {
                    t_product = l_products.get(j);
                    l_products.set(i, t_product);
                    l_products.set(j, product);
                    product = l_products.get(i);
                    c1 = DecimalMath.add(DecimalMath.sub(1.0, DecimalMath.sub(product.getP_height(), product.getP_width())), DecimalMath.sub(score, x1 / y1));
                }
                ++j;
            }
            ++i;
    ...
    public List<Product> scoreAreaProductBi1(List<Product> products, int score) {
        score *= 10000;
        Product t_product = null;
        int i = 0;
        while (i < products.size()) {
            Product product = products.get(i);
            double y1 = product.getP_width();
            double x1 = product.getP_height();
            double c1 = DecimalMath.add(DecimalMath.sub(1.0, DecimalMath.sub(product.getP_height(), product.getP_width())), DecimalMath.sub(score, y1 / x1));
            int j = i + 1;
            while (j < products.size()) {
                double y2 = products.get(j).getP_width();
                double x2 = products.get(j).getP_height();
                double c2 = DecimalMath.add(DecimalMath.sub(1.0, DecimalMath.sub(products.get(j).getP_height(), products.get(j).getP_width())), DecimalMath.sub(score, y2 / x2));
                if (c1 < c2) {
                    t_product = products.get(j);
                    products.set(i, t_product);
                    products.set(j, product);
                    product = products.get(i);
                    c1 = DecimalMath.add(DecimalMath.sub(1.0, DecimalMath.sub(product.getP_height(), product.getP_width())), DecimalMath.sub(score, y1 / x1));
                }
                ++j;
            }
            ++i;
    ...
    public List<Product> scoreAreaProductF1(List<Product> products, int flag, int s_flag) {
        Product t_product = null;
        int i = 0;
        while (i < products.size()) {
            Product product = products.get(i);
            double c1 = (1.0 - 0.2 * (double)flag) * product.getP_width() * product.getP_height() + 0.2 * (double)flag * ((1.0 - 0.2 * (double)s_flag) * product.getP_height() + 0.2 * (double)s_flag * product.getP_width());
            int j = i + 1;
            while (j < products.size()) {
                double c2 = (1.0 - 0.2 * (double)flag) * products.get(j).getP_width() * products.get(j).getP_height() + (double)flag * ((1.0 - 0.2 * (double)s_flag) * products.get(j).getP_height() + 0.2 * (double)s_flag * products.get(j).getP_width());
                if (c1 < c2) {
                    t_product = products.get(j);
                    products.set(i, t_product);
                    products.set(j, product);
                    product = products.get(i);
                    c1 = (1.0 - 0.2 * (double)flag) * product.getP_width() * product.getP_height() + 0.2 * (double)flag * ((1.0 - 0.2 * (double)s_flag) * product.getP_height() + 0.2 * (double)s_flag * product.getP_width());
                }
                ++j;
            }
            ++i;
    ...
    public List<Product> scoreAreaProductF2(List<Product> products, int flag, int s_flag) {
        Product t_product = null;
        int i = 0;
        while (i < products.size()) {
            Product product = products.get(i);
            double c1 = 0.2 * (double)flag * product.getP_width() * product.getP_height() + (1.0 - 0.2 * (double)flag) * ((1.0 - 0.2 * (double)s_flag) * product.getP_height() + 0.2 * (double)s_flag * product.getP_width());
            int j = i + 1;
            while (j < products.size()) {
                double c2 = 0.2 * (double)flag * products.get(j).getP_width() * products.get(j).getP_height() + (1.0 - 0.2 * (double)flag) * ((1.0 - 0.2 * (double)s_flag) * products.get(j).getP_height() + 0.2 * (double)s_flag * products.get(j).getP_width());
                if (c1 < c2) {
                    t_product = products.get(j);
                    products.set(i, t_product);
                    products.set(j, product);
                    product = products.get(i);
                    c1 = 0.2 * (double)flag * product.getP_width() * product.getP_height() + (1.0 - 0.2 * (double)flag) * ((1.0 - 0.2 * (double)s_flag) * product.getP_height() + 0.2 * (double)s_flag * product.getP_width());
                }
                ++j;
            }
            ++i;
