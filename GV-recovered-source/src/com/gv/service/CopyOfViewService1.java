...
public class CopyOfViewService1 {
    public List<Material> createView(List<Product> m_products, List<Material> m_materials, double saw_bite) {
        ...
        while (it.hasNext()) {
            ...
            if ((m_products = this.scoreProduct(m_products, 1)).size() <= 0) continue;
            m_m_no = 0;
            m_p_no = 0;
            p_count = -1;
                            ...
                            if (p_count == 0) {
                                ...
                                while (it_t.hasNext()) {
                                    ...
                                    for (List materials_index : vt) {
                                        block6: for (Material t_m : materials_index) {
                                            for (Product t_p : m_products) {
                                                int pj;
                                                int pi;
                                                Object b_product2;
                                                ...
                                                if (t_m.getR_width() == t_p.getP_width() && t_m.getR_height() >= t_p.getP_height() + saw_bite) {
                                                    ...
                                                    if (1 == pp_count) {
                                                        ...
                                                        if (b_product1 != null && b_product2 != null) {
                                                            ...
                                                            p = new Product();
                                                            p.setM_left(t_m.getM_m_left());
                                                            p.setM_top(t_m.getM_m_top() + b_product1.getP_height() + saw_bite);
                                                            ...
                                                            t_materials = new ArrayList();
                                                            t_material = new Material();
                                                            t_material.setR_height(t_m.getR_height() - ((Product)b_product2).getP_height() - b_product1.getP_height() - 2.0 * saw_bite);
                                                            ...
                                                            t_material.setM_m_top(t_m.getM_m_top() + ((Product)b_product2).getP_height() + b_product1.getP_height() + 2.0 * saw_bite);
                                                            t_materials.add(t_material);
                                                ...
                                                if (t_m.getR_width() >= t_p.getP_width() + saw_bite && t_m.getR_height() == t_p.getP_height()) {
                                                    ...
                                                    if (1 == pp_count) {
                                                        ...
                                                        if (b_product1 != null && b_product2 != null) {
                                                            ...
                                                            p = null;
                                                            p = new Product();
                                                            p.setM_left(t_m.getM_m_left() + b_product1.getP_width() + saw_bite);
                                                            p.setM_top(t_m.getM_m_top());
                                                            p.setP_name(((Product)b_product2).getP_name());
                                                            p.setP_height(((Product)b_product2).getP_height());
                                                            p.setP_width(((Product)b_product2).getP_width());
                                                            ...
                                                            t_material.setR_width(t_m.getR_width() - b_product1.getP_width() - ((Product)b_product2).getP_width() - 2.0 * saw_bite);
                                                            t_material.setM_width(t_m.getM_width());
                                                            t_material.setM_height(t_m.getM_height());
                                                            t_material.setM_f_id(t_m.getM_node_id());
                                                            t_material.setM_node_id(++node_id);
                                                            t_material.setM_c_type(t_m.getM_c_type());
                                                            t_material.setM_hs_type(1);
                                                            t_material.setM_m_left(t_m.getM_m_left() + b_product1.getP_width() + ((Product)b_product2).getP_width() + 2.0 * saw_bite);
