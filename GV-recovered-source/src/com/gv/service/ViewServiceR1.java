...
public class ViewServiceR1 {
    public List<Material> createView(List<Product> m_products, List<Material> m_materials, double saw_bite) {
        ...
        while (it.hasNext()) {
                    ...
                    block168: {
                        block161: {
                            block169: {
                                ...
                                if (mm_products.size() <= 0) break block168;
                                m_m_no = 0;
                                p_count = -1;
                                m_materials = CommonTools.cloneMatList(m_materials_map.get(key));
                                if ((m_materials = this.scoreMaterial(m_materials)) == null) break block169;
                                ...
                                while (i < m_materials.size()) {
                                    ...
                                    int f_i = 0;
                                    while (f_i < 10) {
                                        ArrayList<Product> p_products = new ArrayList<Product>();
                                        Material material = new Material();
                                        m_materials = CommonTools.cloneMatList(m_materials);
                                        Random rd = new Random();
                                        ArrayList<Material> f_materials = new ArrayList<Material>();
                                        m_material = m_materials.get(i);
                                        if (0.0 >= m_material.getM_count()) {
                                            System.out.println("\u677f\u6750\u4e0d\u591f\u4e86");
                                            break;
                                        }
                                        ArrayList<Product> m_ps = new ArrayList();
                                        int j = 0;
                                            ...
                                            if (!(m_material.getR_height() < p.getP_height()) && !(m_material.getR_width() < p.getP_width())) {
                                                ...
                                                if (p_count == 0) {
                                                    ...
                                                    if (p_count != 0) {
                                                        ...
                                                        p = CommonTools.clonePro(product);
                                                        p.setM_left(0.0);
                                                        p.setM_top(0.0);
                                                        p.setP_is_show(0);
                                                        m_ps.add(p);
                                                        p_products.add(p);
                                                        p = null;
                                                        material.setM_products((List<Product>)m_ps);
                                                        ...
                                                        Iterator<Product> it_t = materials_map_index.keySet().iterator();
                                                        while (it_t.hasNext()) {
                                                            ...
                                                            for (List materials_index : vt) {
                                                                block8: for (Material t_m : materials_index) {
                                                                    int t_i = 0;
                                                                    while (t_i < mm_products.size()) {
                                                                        Product t_p = mm_products.get(t_i);
                                                                        ArrayList<Product> e_products = null;
                                                                        if (t_p.getP_r_count() > 0 && (t_p = this.queryIsUsedProduct(p_products, t_p)).getP_r_count() > t_p.getP_p_count()) {
                                                                            int pj;
                                                                            Product t_product2;
                                                                            Object b_product2;
                                                                            double mod;
                                                                            ...
                                                                            if (t_m.getR_width() == t_p.getP_width() && t_m.getR_height() == t_p.getP_height()) {
                                                                                m_ps = new ArrayList<Product>();
                                                                                p = CommonTools.clonePro(t_p);
                                                                            ...
                                                                            if (t_m.getR_width() == t_p.getP_width() && t_m.getR_height() >= t_p.getP_height() + saw_bite) {
                                                                                int pp_count = (int)(t_m.getR_height() / t_p.getP_height());
                                                                                m_mod = 100000.0;
                                                                                mod = 0.0;
                                                                                ...
                                                                                if (1 == pp_count) {
                                                                                    ...
                                                                                    Product b_product1 = null;
                                                                                    b_product2 = null;
                                                                                    Product t_product1 = null;
                                                                                    t_product2 = null;
                                                                                    int pi = 0;
                                                                                    while (pi < e_products.size()) {
                                                                                        pj = e_products.size() - 1;
                                                                                        while (pj >= pi) {
                                                                                            if (pi != pj || (t_product1 = this.queryIsUsedProduct(p_products, (Product)e_products.get(pi))).getP_r_count() > t_product1.getP_p_count() + 1) {
                                                                                                t_product1 = (Product)e_products.get(pi);
                                                                                                t_product2 = (Product)e_products.get(pj);
                                                                                                t_product1 = this.queryIsUsedProduct(p_products, t_product1);
                                                                                                t_product2 = this.queryIsUsedProduct(p_products, t_product2);
                                                                                                if (t_product1.getP_r_count() > t_product1.getP_p_count() && t_product2.getP_r_count() > t_product2.getP_p_count() && (mod = t_m.getR_height() - ((Product)e_products.get(pi)).getP_height() - ((Product)e_products.get(pj)).getP_height() - saw_bite) >= 0.0 && mod < m_mod) {
                                                                                    ...
                                                                                    if (b_product1 != null && b_product2 != null) {
                                                                                        m_ps = new ArrayList();
                                                                                        p = CommonTools.clonePro(b_product1);
                                                                                        p.setM_left(t_m.getM_m_left());
                                                                                        p.setM_top(t_m.getM_m_top());
                                                                                        p.setP_is_show(t_m.getM_node_id());
                                                                                        m_ps.add(p);
                                                                                        p_products.add(p);
                                                                                        p = null;
                                                                                        p = CommonTools.clonePro(b_product2);
                                                                                        p.setM_left(t_m.getM_m_left());
                                                                            ...
                                                                            if (t_m.getR_width() >= t_p.getP_width() + saw_bite && t_m.getR_height() == t_p.getP_height()) {
                                                                                int pp_count = (int)(t_m.getR_width() / t_p.getP_width());
                                                                                m_mod = 100000.0;
                                                                                mod = 0.0;
                                                                                    ...
                                                                                    while (pi < e_products.size()) {
                                                                                        ...
                                                                                        while (pj >= pi) {
                                                                                            if (pi != pj || (t_product1 = this.queryIsUsedProduct(p_products, (Product)e_products.get(pi))).getP_r_count() > t_product1.getP_p_count() + 1) {
                                                                                                ...
                                                                                                t_product1 = this.queryIsUsedProduct(p_products, t_product1);
                                                                                                t_product2 = this.queryIsUsedProduct(p_products, t_product2);
                                                                                                if (t_product1.getP_r_count() > t_product1.getP_p_count() && t_product2.getP_r_count() > t_product2.getP_p_count() && (mod = t_m.getR_width() - ((Product)e_products.get(pi)).getP_width() - ((Product)e_products.get(pj)).getP_width() - saw_bite) >= 0.0 && mod < m_mod) {
                                                                                                    b_product1 = (Product)e_products.get(pi);
                                                                                                    b_product2 = (Product)e_products.get(pj);
                                                                                                    m_mod = mod;
                                                                                                }
                                                                            ...
                                                                            if (t_m.getR_width() >= t_p.getP_width() + saw_bite && t_m.getR_height() >= t_p.getP_height() + saw_bite) {
                                                                                double m_mod2;
                                                                                double r_w = DecimalMath.mul(t_m.getR_width(), t_p.getP_width()) - saw_bite;
                                                                                double r_h = DecimalMath.mul(t_m.getR_height(), t_p.getP_height()) - saw_bite;
                                                                                Product t_t_p = null;
                                                                                double d = m_mod2 = r_w < r_h ? r_w : r_h;
                                                                                if (t_p.getP_p_count() == 0) {
                                                                                    double t_r_w = 0.0;
                                                                                    double t_r_t = 0.0;
                                                                                    double t_mod = 0.0;
                                                                                    int tt_i = t_i + 1;
                                                                                    while (tt_i < mm_products.size()) {
                                                                                        t_t_p = mm_products.get(tt_i);
                                                                                        t_r_w = t_m.getR_width() - t_t_p.getP_width() - saw_bite;
                                                                                        t_r_t = t_m.getR_height() - t_t_p.getP_height() - saw_bite;
                                                                                        if (0.0 <= t_r_w) {
                                                                                            if (0.0 > t_r_t) {
                                                                                                t_mod = t_r_w;
                                                                                            } else if (t_r_w < t_r_t) {
                                                                                        ...
                                                                                        if (t_mod < m_mod2 && (t_t_p = this.queryIsUsedProduct(p_products, t_t_p)).getP_r_count() > t_t_p.getP_p_count()) {
                                                                                    ...
                                                                                    r_w = DecimalMath.mul(t_m.getR_width(), t_p.getP_width()) - saw_bite;
                                                                                    r_h = DecimalMath.mul(t_m.getR_height(), t_p.getP_height()) - saw_bite;
                                                                                } else if (t_m.getM_c_type() == 0 && 1 == t_m.getM_hs_type()) {
                                                                                    int t_t_i = 0;
                                                                                    while (t_t_i < p_products.size()) {
                                                                                        if (t_m.getM_m_left() == ((Product)p_products.get(t_t_i)).getM_left() && t_m.getM_m_top() == ((Product)p_products.get(t_t_i)).getM_top() + ((Product)p_products.get(t_t_i)).getP_height() + saw_bite) {
                                                                                            t_t_p = (Product)p_products.get(t_t_i);
                                                                                            if (t_p.getP_width() == t_t_p.getP_width() && t_p.getP_height() == t_t_p.getP_height()) {
                                                                                                System.out.println("sdfsdfsdfdsf111111");
                                                                                                r_w = 0.0;
                                                                                            }
                                                                                        }
                                                                                        ++t_t_i;
                                                                                    }
                                                                                } else if (1 == t_m.getM_c_type() && t_m.getM_hs_type() == 0) {
                                                                                    int t_t_i = 0;
                                                                                    while (t_t_i < p_products.size()) {
                                                                                        if (t_m.getM_m_top() == ((Product)p_products.get(t_t_i)).getM_top() && t_m.getM_m_left() == ((Product)p_products.get(t_t_i)).getM_left() + ((Product)p_products.get(t_t_i)).getP_width() + saw_bite) {
                                                                                            t_t_p = (Product)p_products.get(t_t_i);
                                                                                            if (t_p.getP_width() == t_t_p.getP_width() && t_p.getP_height() == t_t_p.getP_height()) {
                                                                                                r_h = 0.0;
                                                                                            }
                                                        ...
                                                        ArrayList<Product> f_ps = new ArrayList<Product>();
                                    ...
                                    if (0.85 <= b_material.getM_area_used()) {
                                        int s_i = 0;
                                        while (s_i < b_material.getM_products().size()) {
                                            Product p_i = b_material.getM_products().get(s_i);
                                            if (p_i.getP_is_score() == 0) {
                                                p_i.setP_p_count(1);
                                                int s_j = s_i + 1;
                                                while (s_j < b_material.getM_products().size()) {
                                                    Product p_j = b_material.getM_products().get(s_j);
                                        ...
                                        LinkedList<Integer> zxbs_vc = new LinkedList<Integer>();
                                        int z_i = 0;
                                        while (z_i < b_material.getM_products().size()) {
                                            Product z_product = b_material.getM_products().get(z_i);
                                            if (z_product.getP_is_score() == 0) {
                                                int bs = 0;
                                                for (Product z_p : mm_products) {
                                                    if (!z_product.getP_name().equals(z_p.getP_name()) || z_product.getP_width() != z_p.getP_width() || z_product.getP_height() != z_p.getP_height() || z_product.getP_is_copy() != z_p.getP_is_copy()) continue;
                                                    bs = (int)(z_p.getP_count() / (double)z_product.getP_p_count());
                                                    zxbs_vc.add(bs);
                                                }
                                            }
                                            ++z_i;
                                        }
                                        int m_bs = (Integer)zxbs_vc.get(0);
                                        int m_i = 1;
                                        while (m_i < zxbs_vc.size()) {
                                            if ((Integer)zxbs_vc.get(m_i) < m_bs) {
                                                m_bs = (Integer)zxbs_vc.get(m_i);
                                            }
                                            ++m_i;
                                        }
                                        b_material.setM_u_count(m_bs);
                                    } else {
                                        b_material.setM_u_count(1);
                                    }
                                        ...
                                        for (Product t_p : mm_products) {
                                            if (p_p.getP_is_dir() == 0) {
                                                if (p_p.getP_name().equals(t_p.getP_name()) && p_p.getP_width() == t_p.getP_width() && p_p.getP_height() == t_p.getP_height()) {
                                                    t_p.setP_count(t_p.getP_count() - (double)b_material.getM_u_count());
                                                    t_p.setP_r_count(t_p.getP_r_count() - b_material.getM_u_count());
                                                    continue;
                                                }
                                                if (!p_p.getP_name().equals(t_p.getP_name()) || p_p.getP_width() != t_p.getP_height() || p_p.getP_height() != t_p.getP_width()) continue;
                                                t_p.setP_count(t_p.getP_count() - (double)b_material.getM_u_count());
                                                t_p.setP_r_count(t_p.getP_r_count() - b_material.getM_u_count());
                                                continue;
                                            }
            ...
            for (Material i_m : b_materials) {
                if (i_m.getM_is_yl() != 0 || i_m.getM_is_show() != 0) continue;
                i_material.setM_u_count(i_material.getM_u_count() + i_m.getM_u_count());
            }
    ...
    public Product queryIsUsedProduct(List<Product> p_products, Product t_p) {
        List<Product> usedProducts = p_products;
        t_p.setP_p_count(0);
